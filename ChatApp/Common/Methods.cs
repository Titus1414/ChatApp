...
namespace ChatApp.Common
{
    ...
    {
        public static string baseUrl = "https://localhost:7046/";
        ...
        public static byte[] getKey
        {
            get
            {
                System.Configuration.ConfigurationManager.AppSettings["EncryptKey"] = "vtCRMkey";
                return ASCIIEncoding.ASCII.GetBytes(System.Configuration.ConfigurationManager.AppSettings["EncryptKey"]);
            }
        }
    }
}
